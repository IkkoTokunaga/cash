    ...
    <div class="mb-5">
        <div class="p-4 sm:p-8 bg-white sm:rounded-lg border">
            <div class="max-w-full">
                <a href={{ asset('target_user/create"') }} wire:navigate=""><span
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        wire:model="name" id="name" name="name" type="text" value="テスト売上先">
                                </td>
                            </tr>
                            <tr>
                                <th class="table-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        wire:model="tel" id="tel" tel="tel" type="tel"
                                        value="090-1234-5678">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input
                                        class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1 block shadow-none"
                                        wire:model="email" id="email" name="email" type="text"
                                        value="test@exsample.com">
                                </td>
                            </tr>
                            <tr>
                                <th class="table-success">
                                ...
                                <td>
                                    <input
                                        class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1 block shadow-none"
                                        wire:model="address" id="address" name="address" type="text"
                                        value="東京都港区">
                                </td>
                            </tr>
