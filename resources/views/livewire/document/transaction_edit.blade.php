            ...
            <div class=" max-w-xl">
                <form wire:submit="save">
                    ...
                    <table class="table table-bordered mt-2 ">
                        <tbody>
                            <tr>
                                <th class="table-success"> <label class="block font-medium text-sm text-gray-700"
                                ...
                                <td> <input
                                        ...
                                        wire:model="date" id="date" name="date" type="date"> </td>
                            </tr>
                            <tr>
                                <th class="table-success"> <label class="block font-medium text-sm text-gray-700"
                                ...
                                <td> <select id="account_id" wire:model="account_id"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex justify-start items-center"> <input
                                            ...
                                            wire:model="target_user_id" id="date" name="date"
                                            type="text"> <select id="target_user_id" wire:model="target_user_id"
                                            class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md">
                                            <option value="">選択してください</option>
                            ...
                            <tr>
                                ...
                                <td> <input
                                        ...
                                        wire:model="description" id="description" name="description" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th class="table-success"> <label class="block font-medium text-sm text-gray-700">
                                ...
                                <td> <label for="income">収入 <input type="radio" id="income" value="income"
                                            name="payment_type" class="me-3"
                                            wire:model="selected_payment_type"></label> <label for="expense">支出
                                        <input type="radio" id="expense" value="expense" name="payment_type"
                                            class="me-3" wire:model="selected_payment_type"></label> </td>
                            </tr>
                            <tr>
                                <th class="table-success"> <label class="block font-medium text-sm text-gray-700"
                                ...
                                <td> <input
                                        class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1 block shadow-none"
                                        wire:model="payment" id="payment" name="payment" type="number"> </td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="flex justify-center items-center"> <spantype="submit"
                        ...
                        保存 </span> <a href="http://localhost:8000/transaction/2024-08" wire:navigate=""><span
                                class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xl sm:text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                一覧へ戻る </span> </a> </div>
                </form>
            </div>
                ...
                <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                        ...
                        <tr class="table-info" style="cursor: pointer;">
                            ...
                            <td class="hidden md:table-cell"> 消耗品 </td>
                            <td class="hidden md:table-cell"> </td>
                            <td> <span class="md:hidden text-success"> 【 科目 】消耗品<br> </span> コピー用紙＿A4＿50セット </td>
                            <td class="text-end"> <span class="md:hidden"> -50,000 </span> </td>
                            <td class="text-end hidden md:table-cell"> 50,000 </td>
                            <td class="text-end"> 80,894</td>
                            <td>
